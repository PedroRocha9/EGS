        ...
        <StyledRoot>
            ...
            <StyledContent>
                ...
                <Typography sx={{ color: '#81A1C1', mb: 5 }}>
                    <code>http://localhost:3000/v1/ads?publisher_id={localStorage.getItem('id')}</code>
                </Typography>
                <Typography sx={{ color: 'text.secondary', mb: 2 }}>
                    If you want to request a specific ad location or target audience age, you can add the following parameters:
                </Typography>
                <Typography sx={{ color: '#81A1C1', mb: 5 }}>
                    <code>http://localhost:3000/v1/ads?publisher_id={localStorage.getItem('id')}&location=portugal&age_range=youth</code>
                </Typography>
                <Typography sx={{ color: 'text.secondary', mb: 2 }}>
